...
const homeHandler = (request, h) => {
  return h.response({status: 'Server is running and ready to receive requests!', message: 'Please visit https://github.com/dainovien/note-web-app for more info, Thank You :)', author: 'Dainovien - 2025'});
};
